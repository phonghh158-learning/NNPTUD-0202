...
let data = [
    ...
    },
    {
        ...
        price: 155,
        description: 'Meng Hor Zin TwoMeng Hor Zin TwoMeng Hor Zin TwoMeng Hor Zin Two',
        category: {
            id: 2,
            name: 'Electronics',
            slug: 'electronics',
    ...
    },
    {
        ...
        category: {
            ...
            name: 'Apple',
            slug: 'apple',
            image: 'https://i0.wp.com/www.abcbasket.in/wp-content/uploads/2023/05/apple.png?fit=500%2C500&ssl=1',
...
router.get('/', function (req, res, next) {
    ...
    if (minPrice) {
        result = data.filter((product) => product.price >= parseInt(minPrice));
    }

    if (maxPrice) {
        result = data.filter((product) => product.price <= parseInt(maxPrice));
    }

    if (slug) {
        result = data.filter((product) => product.slug === slug);
    }
